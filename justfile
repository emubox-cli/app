init:
    python3 -m venv ./.venv
    ./.venv/bin/pip install pip-system-certs pyinstaller aiohttp aiofiles pillow
...
@build debug="1" sha="DEBUG":
    ...
    .venv/bin/pyinstaller --onefile --hidden-import pip-system-certs --runtime-tmpdir /tmp -n emubox --runtime-hook /tmp/emubox-env.py src/main.py
